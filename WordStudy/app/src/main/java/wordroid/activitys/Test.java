        ...
        overBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dlg = new AlertDialog.Builder(Test.this)
                        .setTitle("TestResult")
                        .setMessage("All" + listLength + ", right" + score + " Correct Rate" + (score*100/listLength) + "%")
                    ...
                    switch (rightAns) {
                        case 0:
                            if ( checkedId == meaning0.getId() ) {
                                ...
                                DisplayToast("Wrong,Right answer is " + allList.get(opt[0]).getMeanning());
                            }
                            break;
                        case 1:
                            if ( checkedId == meaning1.getId() ) {
                                ...
                                DisplayToast("Wrong,Right answer is " + allList.get(opt[1]).getMeanning() );
                            }
                            break;
                        case 2:
                            if ( checkedId == meaning2.getId() ) {
                                ...
                                DisplayToast("Wrong,Right answer is " + allList.get(opt[2]).getMeanning() );
                            }
                            break;
                        case 3:
                            if ( checkedId == meaning3.getId() ) {
                                ...
                                DisplayToast("Wrong,Right answer is " + allList.get(opt[3]).getMeanning() );
                            }
                            break;
                    }
