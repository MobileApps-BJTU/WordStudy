    ...
    private void UpdateView() {
        ...
        if (currentnum<list.size()){
            ...
            Dialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setMessage("You can see the time to the next review in the review plan")
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Dialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setMessage("Make sure to end? This will lead this time to invalid！")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
	                    /* User clicked OK so do some stuff */
                            tts.shutdown();
    ...
    public void onClick(View v) {
        ...
        if (v==add){
            ...
            if (attention.size()==0){
                ...
                Toast.makeText(Review.this, "Add to glossary", Toast.LENGTH_SHORT).show();
            }
            else Toast.makeText(Review.this, "You already have this word in the glossary!", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
